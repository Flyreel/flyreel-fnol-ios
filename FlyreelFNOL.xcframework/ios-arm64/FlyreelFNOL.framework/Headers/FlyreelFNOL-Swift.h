...
#ifndef FLYREELFNOL_SWIFT_H
#define FLYREELFNOL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FlyreelFNOL",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11FlyreelFNOL26NativeFNOLV3ViewController")
@interface NativeFNOLV3ViewController : UIViewController
- (void)viewDidLoad;
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("FlyreelFNOL", usrValue)
#ifndef SWIFT_PRINTED_CORE
#define SWIFT_PRINTED_CORE
namespace swift SWIFT_PRIVATE_ATTR {
...
#endif
#ifdef __cplusplus
namespace FlyreelFNOL SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("FlyreelFNOL") {
namespace _impl {
extern "C" {
#endif

SWIFT_EXTERN void * _Nonnull $s11FlyreelFNOL0A8FNOLTestCACycfC(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // init()
SWIFT_EXTERN void $s11FlyreelFNOL0A8FNOLTestC23testSharedCaptureModuleyyF(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // testSharedCaptureModule()
SWIFT_EXTERN void $s11FlyreelFNOL0A8FNOLTestC23testSharedCaptureModuleyyFTj(SWIFT_CONTEXT void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // dispatch thunk for testSharedCaptureModule()
SWIFT_EXTERN ptrdiff_t $s11FlyreelFNOL20RecordingFinishStateO9hashValueSivg(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // _
...
class SWIFT_SYMBOL("s:11FlyreelFNOL15FNOLCaptureViewV") FNOLCaptureView;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<FlyreelFNOL::FNOLCaptureView> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_FNOLCaptureView;

// Type metadata accessor for FNOLCaptureView
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s11FlyreelFNOL15FNOLCaptureViewVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:11FlyreelFNOL15FNOLCaptureViewV") FNOLCaptureView final {
public:
  SWIFT_INLINE_THUNK ~FNOLCaptureView() noexcept {
    auto metadata = _impl::$s11FlyreelFNOL15FNOLCaptureViewVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK FNOLCaptureView(const FNOLCaptureView &other) noexcept {
    auto metadata = _impl::$s11FlyreelFNOL15FNOLCaptureViewVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK FNOLCaptureView &operator =(const FNOLCaptureView &other) noexcept {
    auto metadata = _impl::$s11FlyreelFNOL15FNOLCaptureViewVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK FNOLCaptureView &operator =(FNOLCaptureView &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER FNOLCaptureView(FNOLCaptureView &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
private:
  SWIFT_INLINE_THUNK FNOLCaptureView(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK FNOLCaptureView _make() noexcept {
    auto metadata = _impl::$s11FlyreelFNOL15FNOLCaptureViewVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
    ...
    auto *vwTable = *vwTableAddr;
#endif
    return FNOLCaptureView(vwTable);
  }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage.getOpaquePointer(); }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage.getOpaquePointer(); }

  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_FNOLCaptureView;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s11FlyreelFNOL15FNOLCaptureViewVD;
  static inline constexpr $s11FlyreelFNOL15FNOLCaptureViewVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_FNOLCaptureView {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(FNOLCaptureView &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const FNOLCaptureView &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER FNOLCaptureView returnNewValue(T callable) {
    auto result = FNOLCaptureView::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<FlyreelFNOL::FNOLCaptureView> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return FlyreelFNOL::_impl::$s11FlyreelFNOL15FNOLCaptureViewVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<FlyreelFNOL::FNOLCaptureView> = true;
template<>
static inline const constexpr bool isOpaqueLayout<FlyreelFNOL::FNOLCaptureView> = true;
template<>
struct implClassFor<FlyreelFNOL::FNOLCaptureView> { using type = FlyreelFNOL::_impl::_impl_FNOLCaptureView; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:11FlyreelFNOL0A8FNOLTestC") FlyreelFNOLTest;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<FlyreelFNOL::FlyreelFNOLTest> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_FlyreelFNOLTest;
// Type metadata accessor for FlyreelFNOLTest
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s11FlyreelFNOL0A8FNOLTestCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:11FlyreelFNOL0A8FNOLTestC") FlyreelFNOLTest : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK FlyreelFNOLTest init() SWIFT_SYMBOL("s:11FlyreelFNOL0A8FNOLTestCACycfc");
  SWIFT_INLINE_THUNK void testSharedCaptureModule() SWIFT_SYMBOL("s:11FlyreelFNOL0A8FNOLTestC23testSharedCaptureModuleyyF");
protected:
  SWIFT_INLINE_THUNK FlyreelFNOLTest(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_FlyreelFNOLTest;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s11FlyreelFNOL0A8FNOLTestCD;
  static inline constexpr $s11FlyreelFNOL0A8FNOLTestCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_FlyreelFNOLTest {
public:
static SWIFT_INLINE_THUNK FlyreelFNOLTest makeRetained(void * _Nonnull ptr) noexcept { return FlyreelFNOLTest(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<FlyreelFNOL::FlyreelFNOLTest> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return FlyreelFNOL::_impl::$s11FlyreelFNOL0A8FNOLTestCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<FlyreelFNOL::FlyreelFNOLTest> { using type = FlyreelFNOL::_impl::_impl_FlyreelFNOLTest; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:11FlyreelFNOL20RecordingFinishStateO") RecordingFinishState;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<FlyreelFNOL::RecordingFinishState> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_RecordingFinishState;

// Type metadata accessor for RecordingFinishState
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s11FlyreelFNOL20RecordingFinishStateOMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;

// Tags for resilient enum RecordingFinishState
extern "C" {
extern unsigned $s11FlyreelFNOL20RecordingFinishStateO7successyA2CmFWC;
extern unsigned $s11FlyreelFNOL20RecordingFinishStateO4redoyA2CmFWC;
extern unsigned $s11FlyreelFNOL20RecordingFinishStateO5abortyA2CmFWC;
}

} // namespace _impl

class SWIFT_SYMBOL("s:11FlyreelFNOL20RecordingFinishStateO") RecordingFinishState final {
public:
  SWIFT_INLINE_THUNK ~RecordingFinishState() noexcept {
    auto metadata = _impl::$s11FlyreelFNOL20RecordingFinishStateOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK RecordingFinishState(const RecordingFinishState &other) noexcept {
    auto metadata = _impl::$s11FlyreelFNOL20RecordingFinishStateOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK RecordingFinishState &operator =(const RecordingFinishState &other) noexcept {
    auto metadata = _impl::$s11FlyreelFNOL20RecordingFinishStateOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK RecordingFinishState &operator =(RecordingFinishState &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER RecordingFinishState(RecordingFinishState &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
  ...
  enum class cases {
    success SWIFT_SYMBOL("s:11FlyreelFNOL20RecordingFinishStateO7successyA2CmF"),
    redo SWIFT_SYMBOL("s:11FlyreelFNOL20RecordingFinishStateO4redoyA2CmF"),
    abort SWIFT_SYMBOL("s:11FlyreelFNOL20RecordingFinishStateO5abortyA2CmF"),
    unknownDefault
  };
...
#pragma clang diagnostic ignored "-Wc++17-extensions"  // allow use of inline static data member
  inline const static struct _impl_success {  // impl struct for case success
    ...
    SWIFT_INLINE_THUNK RecordingFinishState operator()() const;
  } success SWIFT_SYMBOL("s:11FlyreelFNOL20RecordingFinishStateO7successyA2CmF");
  SWIFT_INLINE_THUNK bool isSuccess() const;

  inline const static struct _impl_redo {  // impl struct for case redo
    SWIFT_INLINE_THUNK constexpr operator cases() const {
      return cases::redo;
    }
    SWIFT_INLINE_THUNK RecordingFinishState operator()() const;
  } redo SWIFT_SYMBOL("s:11FlyreelFNOL20RecordingFinishStateO4redoyA2CmF");
  SWIFT_INLINE_THUNK bool isRedo() const;
...
#pragma clang diagnostic pop
  SWIFT_INLINE_THUNK operator cases() const {
    ...
    if (tag == _impl::$s11FlyreelFNOL20RecordingFinishStateO7successyA2CmFWC) return cases::success;
    if (tag == _impl::$s11FlyreelFNOL20RecordingFinishStateO4redoyA2CmFWC) return cases::redo;
    if (tag == _impl::$s11FlyreelFNOL20RecordingFinishStateO5abortyA2CmFWC) return cases::abort;
    return cases::unknownDefault;
  }

  SWIFT_INLINE_THUNK swift::Int getHashValue() const SWIFT_SYMBOL("s:11FlyreelFNOL20RecordingFinishStateO9hashValueSivp");
private:
  SWIFT_INLINE_THUNK RecordingFinishState(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK RecordingFinishState _make() noexcept {
    auto metadata = _impl::$s11FlyreelFNOL20RecordingFinishStateOMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
    ...
    auto *vwTable = *vwTableAddr;
#endif
    return RecordingFinishState(vwTable);
  }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage.getOpaquePointer(); }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage.getOpaquePointer(); }
  ...
  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_RecordingFinishState;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s11FlyreelFNOL20RecordingFinishStateOD;
  static inline constexpr $s11FlyreelFNOL20RecordingFinishStateOD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_RecordingFinishState {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(RecordingFinishState &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const RecordingFinishState &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER RecordingFinishState returnNewValue(T callable) {
    auto result = RecordingFinishState::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<FlyreelFNOL::RecordingFinishState> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return FlyreelFNOL::_impl::$s11FlyreelFNOL20RecordingFinishStateOMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<FlyreelFNOL::RecordingFinishState> = true;
template<>
static inline const constexpr bool isOpaqueLayout<FlyreelFNOL::RecordingFinishState> = true;
template<>
struct implClassFor<FlyreelFNOL::RecordingFinishState> { using type = FlyreelFNOL::_impl::_impl_RecordingFinishState; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
namespace FlyreelFNOL SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("FlyreelFNOL") {
  ...
  SWIFT_INLINE_THUNK FlyreelFNOLTest FlyreelFNOLTest::init() {
  return _impl::_impl_FlyreelFNOLTest::makeRetained(_impl::$s11FlyreelFNOL0A8FNOLTestCACycfC(swift::TypeMetadataTrait<FlyreelFNOLTest>::getTypeMetadata()));
  }
  SWIFT_INLINE_THUNK void FlyreelFNOLTest::testSharedCaptureModule() {
  return _impl::$s11FlyreelFNOL0A8FNOLTestC23testSharedCaptureModuleyyFTj(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK RecordingFinishState RecordingFinishState::_impl_success::operator()() const {
    auto result = RecordingFinishState::_make();
    result._destructiveInjectEnumTag(_impl::$s11FlyreelFNOL20RecordingFinishStateO7successyA2CmFWC);
    return result;
  }
  SWIFT_INLINE_THUNK  bool RecordingFinishState::isSuccess() const {
    return *this == RecordingFinishState::success;
  }
  SWIFT_INLINE_THUNK RecordingFinishState RecordingFinishState::_impl_redo::operator()() const {
    auto result = RecordingFinishState::_make();
    result._destructiveInjectEnumTag(_impl::$s11FlyreelFNOL20RecordingFinishStateO4redoyA2CmFWC);
    return result;
  }
  SWIFT_INLINE_THUNK  bool RecordingFinishState::isRedo() const {
    return *this == RecordingFinishState::redo;
  }
  SWIFT_INLINE_THUNK RecordingFinishState RecordingFinishState::_impl_abort::operator()() const {
    auto result = RecordingFinishState::_make();
    result._destructiveInjectEnumTag(_impl::$s11FlyreelFNOL20RecordingFinishStateO5abortyA2CmFWC);
    return result;
  }
  SWIFT_INLINE_THUNK  bool RecordingFinishState::isAbort() const {
    return *this == RecordingFinishState::abort;
  }
  SWIFT_INLINE_THUNK  bool RecordingFinishState::isUnknownDefault() const {
    return *this == RecordingFinishState::unknownDefault;
  }
  SWIFT_INLINE_THUNK swift::Int RecordingFinishState::getHashValue() const {
  return _impl::$s11FlyreelFNOL20RecordingFinishStateO9hashValueSivg(_getOpaquePointer());
  }

} // namespace FlyreelFNOL
